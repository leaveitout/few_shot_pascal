...
class GradCAM:
    ...
    def __init__(
        ...
        Args:
            ...
            data_mean (tensor or list): mean value to add to input images.
            data_std (tensor or list): std to multiply for input images.
    ...
    def _calculate_localization_map(self, inputs, labels=None):
        ...
        Args:
            inputs (tensors): the input clips.
