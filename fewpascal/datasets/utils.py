...
def retry_load_images(image_paths, retry=10, backend="pytorch", to_rgb=False):
    """
    ...
    Args:
        ...
        to_rgb: convert to crgb

    Returns:
        imgs (list): list of loaded images of shape (H, W, C), in BGR format.
    """
...
def spatial_sampling(
    ...
    """
    Perform spatial sampling on the given frames. If spatial_idx is
    ...
    Args:
        ...
        crop_size (int): the size of height and width used to crop the
            frames.
        random_horizontal_flip (bool): if True, randomly flip.
